  ...
  <v-container class="mb-12">
    <v-card>
      <v-form ref="form" v-model="valid">
          ...
          <v-tab-item>
            <v-container>
              <v-card flat>
                ...
                <!-- row 1 App_type & App_license_type field -->
                ...
                <v-row dense class="align-center">
                  ...
                  <v-col cols="12" xs="12" sm="12" md="3" lg="3">
                    <v-text-field
                      ...
                      :rules="[rules.number, rules.space]"
                      filled
                    ></v-text-field>
                  </v-col>
        ...
        <v-dialog v-model="draftDialog" persistent max-width="290">
          <template v-slot:activator="{ on }">
  ...
  computed: {
    ...
    doc () {
      return [
        ...
        {text: this.$t("company_license_register_page.tab_2.title_3.header_file_type"), value: "app_doc_type_name"},
    ...
    docWithIndex () {
      return this.doc_list.map(
        (doc_list, index) => ({
          ...doc_list,
          index: index + 1,
          app_doc_type_name: this.getDocTypeName(doc_list.app_doc_type_id)
        })
      )
    }
  },
